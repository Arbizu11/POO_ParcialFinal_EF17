...
public class Tarjeta { // 00379223 Define la clase Tarjeta
    ...
    private String numero_tarjeta; // 00379223 Declara una variable privada para almacenar el número de la tarjeta
    ...
    public Tarjeta(int id, String numero, LocalDate fechaExp, String tipo, int id_cliente, String facilitador) { // 00379223 Constructor de la clase Tarjeta
        ...
        this.numero_tarjeta = numero; // 00379223 Inicializa la variable numero con el valor pasado como parámetro
    ...
    public String getNumero_tarjeta() { // 00379223 Método getter para obtener el número de la tarjeta
        return numero_tarjeta; // 00379223 Retorna el valor de la variable numero
    }

    public void setNumero_tarjeta(String numero_tarjeta) { // 00379223 Método setter para establecer el número de la tarjeta
        this.numero_tarjeta = numero_tarjeta; // 00379223 Asigna el valor pasado como parámetro a la variable numero
    }
